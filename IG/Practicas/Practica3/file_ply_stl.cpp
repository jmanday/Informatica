...
Next_token, i, j, Num_vertices, Num_faces = 0;
                ...
                if (Next_token==NUMBER)
                    ...
                    while (Next_token!=END_HEADER)
                        ...
                        if (Next_token==ELEMENT)
                            ...
                            Num_vertices=(int) Yylval.Real;
                                        obj.resizevertices(Num_vertices);
                                        }
                    ...
                    for (i=0;i<Num_vertices;i++)
                        ...
                        for (j=0;j<3;j++)
                            ...
                            if (Next_token==NUMBER)
                                {
                                    obj.setvertices(i*3+j, i, Yylval.Real);
                    ...
                    for (i=0;i<Num_faces;i++)
                        ...
                        for (j=0;j<3;j++)
                            ...
                            if (Next_token==NUMBER)
                                {
                                    obj.setcaras(i*3+j, i, (int)Yylval.Real);
