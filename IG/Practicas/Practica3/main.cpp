...
// angulos de rotacion para cada jerarquía
float a = 0.0;
float b = 0.0;
float c = 0.0;
...
void normal_keys(unsigned char Tecla1,int x,int y)
{
    ...
    if (toupper(Tecla1)=='C') a += 1;
    if (toupper(Tecla1)=='V') a -= 1;
    if (toupper(Tecla1)=='B') b += 1;
    if (toupper(Tecla1)=='N') b -= 1;
    if (toupper(Tecla1)=='D') c += 1;
    if (toupper(Tecla1)=='F') c -= 1;
}
