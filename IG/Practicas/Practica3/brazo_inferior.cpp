...
brazo_inferior::brazo_inferior(){
    float vpuntos[] = {0.5, 1.75, 0.0, 0.5, -1.75, 0.0};
...
/*********************************************************/
void brazo_inferior::draw(int m, float a, float a2){
    brazo_superior b;
...
/*********************************************************/
void brazo_inferior::draw_vertices()
{
...
/*********************************************************/
void brazo_inferior::draw_alambres(){
...
/***********************************************************/
void brazo_inferior::draw_ajedrez(){
