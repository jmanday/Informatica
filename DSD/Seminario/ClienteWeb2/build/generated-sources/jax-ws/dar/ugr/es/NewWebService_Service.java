 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://es.ugr.dar/", wsdlLocation = "http://localhost:8084/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://es.ugr.dar/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/WebApplication1/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://es.ugr.dar/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://es.ugr.dar/", "NewWebServicePort"), NewWebService.class, features);
    }
