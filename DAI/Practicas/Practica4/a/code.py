...
class classingresos:
	...
	def POST(self):
		...
		if not formulario_ingresos.validates():
			...
			varMakoaux.append(i.tipo_grafica)
			
			#for i in range(0, db.visitas.count()):
			
			return render.mostrar_grafica(varMako = varMakoaux)
